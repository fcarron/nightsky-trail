...
const phraseTranslations: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    Basiskarte: "Base map",
    "swisstopo Light": "swisstopo Light",
    "swisstopo Standard": "swisstopo Standard",
    "swisstopo Satellit": "swisstopo Satellite",
    "Offizielle Wanderwege": "Official hiking trails",
    Wanderland: "Hiking in Switzerland",
    Sperrungen: "Closures",
    Sperrung: "Closure",
    Veloland: "Cycling in Switzerland",
    "Wasser & WCs": "Water & toilets",
    "Informationen zu Wasser- und WC-Daten":
      "Water and toilet data information",
    "Trinkwasserstellen und WCs stammen aus OpenStreetMap. Die Daten werden von der Community gepflegt und können fehlen, veraltet oder falsch sein. Prüfe die Situation vor Ort.":
      "Drinking-water points and toilets come from OpenStreetMap. The community maintains this data, which can be missing, outdated or incorrect. Check conditions on site.",
    "SAC-Hütten": "SAC huts",
    "SAC-Hütte": "SAC hut",
    "SAC-Hütte Details": "SAC hut details",
    Trinkwasser: "Drinking water",
    "Trinkwasser Details": "Drinking water details",
    "Saisonal verfügbar": "Seasonally available",
    Ganzjährig: "Available year-round",
    "WC Details": "Toilet details",
    "Öffentliches WC": "Public toilet",
    "Öffentlich zugänglich (laut OSM)":
      "Publicly accessible (according to OSM)",
  ...
  fr: {
    ...
    Wanderland: "La Suisse à pied",
    Sperrungen: "Fermetures",
    Sperrung: "Fermeture",
    Veloland: "La Suisse à vélo",
    "Wasser & WCs": "Eau & WC",
    "Informationen zu Wasser- und WC-Daten":
      "Informations sur les données d'eau et de WC",
    "Trinkwasserstellen und WCs stammen aus OpenStreetMap. Die Daten werden von der Community gepflegt und können fehlen, veraltet oder falsch sein. Prüfe die Situation vor Ort.":
      "Les points d'eau potable et les WC proviennent d'OpenStreetMap. Ces données sont entretenues par la communauté et peuvent être absentes, obsolètes ou incorrectes. Vérifiez la situation sur place.",
    "SAC-Hütten": "Cabanes CAS",
    "SAC-Hütte": "Cabane CAS",
    "SAC-Hütte Details": "Détails de la cabane CAS",
    Trinkwasser: "Eau potable",
    "Trinkwasser Details": "Détails de l'eau potable",
    "Saisonal verfügbar": "Disponible en saison",
    Ganzjährig: "Disponible toute l'année",
    "WC Details": "Détails des WC",
    "Öffentliches WC": "WC public",
    "Öffentlich zugänglich (laut OSM)": "Accessible au public (selon OSM)",
    Rollstuhlgängig: "Accessible en fauteuil roulant",
  ...
  it: {
    ...
    Wanderland: "Svizzera a piedi",
    Sperrungen: "Chiusure",
    Sperrung: "Chiusura",
    Veloland: "Svizzera in bici",
    "Wasser & WCs": "Acqua & WC",
    "Informationen zu Wasser- und WC-Daten":
      "Informazioni sui dati di acqua e WC",
    "Trinkwasserstellen und WCs stammen aus OpenStreetMap. Die Daten werden von der Community gepflegt und können fehlen, veraltet oder falsch sein. Prüfe die Situation vor Ort.":
      "I punti di acqua potabile e i WC provengono da OpenStreetMap. I dati sono mantenuti dalla comunità e possono essere assenti, obsoleti o errati. Verifica la situazione sul posto.",
    "SAC-Hütten": "Capanne CAS",
    "SAC-Hütte": "Capanna CAS",
    "SAC-Hütte Details": "Dettagli della capanna CAS",
    Trinkwasser: "Acqua potabile",
    "Trinkwasser Details": "Dettagli dell'acqua potabile",
    "Saisonal verfügbar": "Disponibile stagionalmente",
    Ganzjährig: "Disponibile tutto l'anno",
    "WC Details": "Dettagli WC",
    "Öffentliches WC": "WC pubblico",
    "Öffentlich zugänglich (laut OSM)": "Accessibile al pubblico (secondo OSM)",
    Rollstuhlgängig: "Accessibile in sedia a rotelle",
